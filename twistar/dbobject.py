...
class DBObject(Validator):
    ...
    def __init__(self, **kwargs):
        ...
        self._config = self.REGISTRY.getConfig()
    ...
    def find(klass, id=None, where=None, group=None, limit=None, orderby=None):
        ...
        """
        config = klass.REGISTRY.getConfig()
    ...
    def __str__(self):
        ...
        attrs = {}
        if self.REGISTRY.SCHEMAS.has_key(tablename):
            for key in self.REGISTRY.SCHEMAS[tablename]:
